<?php  
	...
	if (isset($_GET['proses'])) {
		if ($_GET['proses'] == 'tambah') {
			...
			$dataDiv = "SELECT * FROM tb_host WHERE nama_divisi = '$bagianAlamat'";
			$retDataDiv = mysqli_query($conn, $dataDiv);
			$data = mysqli_fetch_assoc($retDataDiv);

			if ($bagianAlamat == $data['nama_divisi'] || $hostIp == $data['jumlah_host']) {
				$_SESSION['status'] = 'warning';
				$_SESSION['pesan'] = 'Nama divisi atau jumlah host sudah ada!';
