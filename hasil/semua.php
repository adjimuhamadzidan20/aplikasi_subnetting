<div class="cetak-hasil mb-3 d-flex justify-content-end">
	<div class="opsi">
		<a href="proses/cetak_hasil_pdf.php?proses=hasil_semua" class="btn btn-outline-info btn-sm">Cetak PDF</a>
		<a href="proses/cetak_hasil_excel.php?proses=hasil_semua" class="btn btn-outline-info btn-sm">Cetak Excel</a>
	</div>
</div>
<table class="table">
  <thead>
